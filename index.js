...
document.querySelector('#todayDescription')
    .textContent = descriptions.find(d => d[0]=== data.current.weather_descrption)[1]
...
document.querySelector('#todayStats div:nth-chidl (3)')
    .textContent = `Humidity: ${data.current.humidity}%`
document.querySelector ('#todayStats div:nth-child (4)')
    .textContent = `Wind: ${data.currnt.wind_speed} m/s`

    data.forecast.daily.forEach((data,idx) => {
